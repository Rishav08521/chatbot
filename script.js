...
function waitAndResponce(inputText) {
    ...
    if(inputText.toLowerCase().includes("my name is")){
        ...
        if(name.toLowerCase().includes("Rishav")){
    ...
    switch (inputText.toLowerCase().trim()) {
        case "intro":
            setTimeout(() => {
                sendTextMessage("Hello there 👋🏻,<br><br>My name is <span class='bold'><a class='alink'>Rishav KUmar</a>.</span><br><br>I am a Computer Science Engineering student at <span class='bold'>National Institute of Technology Patna👨🏻‍💻📚</span><br><br>I am eager to hear about potential career opportunities, so I would be pleased to chat about job openings in the engineering sphere.<br><br>Send <span class='bold'>'help'</span> to know more about me.<br>");
            }, 2000);
            break;
        ...
        case "help":
            sendTextMessage("<span class='sk'>Send Keyword to get what you want to know about me and also about zeotap...<br>e.g<br><span class='bold'>'skills'</span> - to know my skills<br><span class='bold'>'resume'</span> - to get my resume<br><span class='bold'>'education'</span> - to get my education details<br><span class='bold'>'contact'</span> - to get ways to connect with me<br><span class='bold'>'projects'</span> - to get details of my projects<br><span class='bold'>'clear'</span> - to clear conversation<br>");
            break;
        case "resume":
        ...
        case "education":
            sendTextMessage("I am currently pusuing B.TECH degree in Computer Science Engineering from NIT PATNA COLLEGE<br>Passing Year : 2024<br><br>I have completed my 12TH from Excellent NALANDA COLLEGE <br>Passing Year:2021<br>Result:68.3%<br><br>I have completed my Secondary school from SADAR ALAM SECONDARY SCHOOL <br>Passing Year:2019");
            break;
        ...
        case "contact":
            ...
            break;
        case "projects":
            sendTextMessage("You want to check my projects? Then just jump into my Github Account.<br><br><div class='social'><a target='_blank' href='https://github.com/Rishav08521'> <div class='socialItem'><img class='socialItemI' src='images/github.svg' alt=''></div> </a></div>");
            break;
        case "time":
            var date = new Date();
        ...
        case "hi":
            ...
            sendTextMessage("<span class='sk'>Send Keyword to get what you want to know about me...<br>e.g<br><span class='bold'>'skills'</span> - to know my skills<br><span class='bold'>'resume'</span> - to get my resume<br><span class='bold'>'education'</span> - to get my education details<br><span class='bold'>'contact'</span> - to get ways to connect with me<br><span class='bold'>'projects'</span> - to get details of my projects<br><span class='bold'>'clear'</span> - to clear conversation<br>");
            break;
        case "How do I set up a new source in Segment?":
            sendTextMessage("How do I set up a new source in Segment?");
        ...
        case "website":
            sendTextMessage("You can check my website here <a target='_blank' href='https://github.com/Rishav08521'>Rishav Kumar</a>");
            break;
        case "blog":
            sendTextMessage("You can check my blog here <a target='_blank' href='https://github.com/Rishav08521'>Rishav Kumar</a>");
            break;
        
        case "github":
            sendTextMessage("You can check my github here <a target='_blank' href='https://github.com/Rishav08521'>Rishav Kumar</a>");
            break;
        case "linkedin":
            sendTextMessage("You can check my linkedin here <a target='_blank' href=' https://www.linkedin.com/in/rishav-kumar-1a5b36262/'>Rishav Kumar</a>");
            break;
        case "friends":
        case "friend":
